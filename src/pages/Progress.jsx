...
function Progress() {
  ...
  return (
    <div className="px-4 py-1 bg-[#252525]">
  <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-4 lg:gap-4">
    <div className="bg-[#252525] rounded-md flex justify-end">
    ...
    <div className="p-4 bg-[#303030] rounded-md mt-5 flex items-center justify-center">
        <img src={ProgressImg} />
    </div>
    </div>
