  ...
  <ProfileCard />
    ...
    <form className="space-y-6" action="#">
        ...
        <div className="relative mb-3" data-te-input-wrapper-init>
            ...
            <div>
            <Link to="submit" className="w-full  text-zinc-100 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-orange-300 hover:bg-blue-700 focus:ring-blue-800">Skapa konto</Link></div>
            </form>
          </div>
    </div>
  </div>
